Public Class Form1
    ...
    Private Sub MenuALexico_Click(sender As Object, e As EventArgs) Handles MenuAnalisis.Click
        Try
            Dim childControl As Control
            If (TabControl.SelectedTab.HasChildren) Then
                For Each childControl In TabControl.SelectedTab.Controls
        ...
        Else
            MessageBox.Show("Análisis léxico finalizado satisfactoriamente", "¡EXITO!")
            sintactico.Analizar()
        End If
    End Sub
    ...
    Private Sub MenuResultado_Click(sender As Object, e As EventArgs) Handles MenuResultado.Click

        If (ListaError.listaError.Count = 0) Then
            Try
                archivos.graficaHTML()
                MessageBox.Show("Resultados estadisticos obtenidos correctamente", "¡EXITO!")
                'System.Diagnostics.Process.Start("file:///C:/Users/Public/Documents/grafica.html")
                System.Diagnostics.Process.Start("file:///C:/Users/u/Desktop/grafica.html")
            ...
            End Try
        Else
            MessageBox.Show("Hay errores, no se puede proceder a dar los resultados", "¡ERROR!")
        End If
    End Sub
    ...
    Private Sub MenuAcerca_Click(sender As Object, e As EventArgs) Handles MenuAcerca.Click
